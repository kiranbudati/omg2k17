...
date_default_timezone_set("Asia/Kolkata");
  ...
  error_reporting(E_ALL);
	...
	$get_status = "SELECT * FROM omg2k17_help_desk  ORDER BY id DESC";
    ...
    if($numStatus>0){
	    ...
	    foreach ($rowStatus as $ft_tasks) {
			...
			//$date2 = date("Y-m-d H:i:s")-$ft_tasks['post_time'];
			...
			$update ='<img src="update.gif" alt="update">'; 
	    		...
	    		echo '
	    			<li class="item">
	                  	<a href="#" class="product-title"><span style="word-wrap: break-word;">'.$ft_tasks['help_desk'].''.$update.'</a>
