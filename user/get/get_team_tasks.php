  ...
  error_reporting(E_ALL);
	...
	if($num>0){
		foreach ($row as $men_tas) {
			if($men_tas['person_type']=="Mentor"){
	    		
	    		$person_type = '<span class="label label-danger">Mentor</span>';

	    	}
	    	else{
				$person_type = '<span class="label label-info">Maker</span>';	    		
	    	}
			...
			echo '<div class="panel panel-primary">
				      ...
				      <div class="panel-body">
				      	...
				      	<dt>Task Title:</dt>
			                ...
			                <dt>Task By :</dt>
			                <dd>'.$men_tas['fullname'].' '.$person_type.'</dd>
			                <dt>Task to :</dt>
