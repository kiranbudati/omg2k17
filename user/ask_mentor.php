          ...
          <li class="treeview active">
            ...
            <ul class="treeview-menu">
              <li><a href="ask_admin.php"><i class="fa fa-question"></i> Ask Admin</a></li>
               <li class="active"><a href="ask_mentor.php"><i class="fa fa-question"></i> Ask Mentor</a></li>
 ...
 <input type="hidden" name="user_name" id="user_email1" value="<?php echo $_SESSION['user_email'] ?>">
    <!-- Content Wrapper. Contains page content -->
      ...
      <section class="content-header">
        <h1>
          Questions
          <small>Ask Mentor</small>
        </h1>
        <ol class="breadcrumb">
          <li><a href="#"><i class="fa fa-dashboard"></i> Questions</a></li>
          <li class="active">Ask Mentor</li>
        </ol>
      </section>
          ...
          <div class="col-md-8">
            <div class="box box-info ">
              <div class="box-header with-border">
                <h3 class="box-title">Write Question to Mentor</h3>
              </div>
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="question_description">Question title</label>
  ...
  <script type="text/javascript">
    ...
    $(".post_question").click(function(){ 
      ...
      if(question_title==""||question_description==""){
        ...
        $.ajax({
              type: "POST",
              url: "send/post_ask_mentor.php",
              data: dataString,
              success: function() {
                swal("Question Posted to Mentor!", "we will get back  to you soon!", "success");
                $("#question_title").val('');
