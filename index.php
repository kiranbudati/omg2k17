    		...
    		<form method="post" role="form" action="#" id="register-form" autocomplete="off">
         		<div class="form-header">
					...
					<div class="pull-right">
             			<h3 class="form-title"><a href="signup.php">Sign Up</a></h3>
 			        </div>              
	    	    </div>  
       ...
       $("#login").click(function(){
	      ...
	      success: function(data){
			  ...
			  showConfirmButton: false
	      		 ...
	      		 setTimeout(' window.location.href = "user/dashboard.php"; ',1000);
...
swal("Success!","Email confirmed!! Please Login to continue", "success");</script>';
