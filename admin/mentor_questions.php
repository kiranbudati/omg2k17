...
<div class="wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="mentor_questions.php"><i class="fa fa-question"></i>Mentor Questions</a></li>
  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <!-- Content Header (Page header) -->
      ...
      <h1>
        Questions
        <small>Mentor questions</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i>Questions</a></li>
        <li class="active">Mentor Questions</li>
      </ol>
    </section>
    <!-- Main content -->
              ...
              <?php
                ...
                if($num>0){
                  foreach ($row as $ft_qu) {
                    ...
                    echo '  <li style="word-break: break-all" class="list-group-item"><a href="mentor_questions.php?question='.$ft_qu['id'].'">'.$ft_qu['question_title'].'</a></li>';
                  }
                }
                else{
