    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="admin_questions.php"><i class="fa fa-question"></i> Admin questions</a></li>
                ...
                if($numq>0){
                    ...
                    <div class="box-header with-border">
                      ...
                      <div class="user-block">
                        ...
                        <span class="description">by <a>'.$ft_lastq['author_name'].' </a> &nbsp; at &nbsp; <a>'.$ft_lastq['post_time'].'</a></span>
                      </div>
                      <!-- /.box-tools -->
                    </div>
                    <!-- /.box-header -->
                ...
                if($numqa>0){
                    ...
                    <div class="box-header with-border">
                      ...
                      <div class="user-block">
                        ...
                        <span class="description">by &nbsp;: &nbsp;'.$ft_lastqa['author_name'].'&nbsp; at &nbsp;: &nbsp; '.$ft_lastqa['post_time'].' </span>
                      </div>
                      <!-- /.box-tools -->
                    </div>
                    <!-- /.box-header -->
              ...
              <?php
                ...
                if($num>0){
                  foreach ($row as $ft_qu) {
                    ...
                    echo '  <li style="word-break: break-all" class="list-group-item"><a href="admin_questions.php?question='.$ft_qu['id'].'">'.$ft_qu['question_title'].'</a></li>';
                  }
                }
                else{
  ...
  <script type="text/javascript">
    $(document).ready(function(){
      ...
      function get_comments(){
        ...
        var dataString = 'question_title='+question_title;
