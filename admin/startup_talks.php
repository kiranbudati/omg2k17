  ...
  <div class="wrapper">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview active">
            ...
            <ul class="treeview-menu">
              ...
              <li class="active"><a href="startup_talks.php"><i class="fa fa-microphone"></i>Startup Talks</a></li>
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="admin_questions.php"><i class="fa fa-circle-o"></i> Admin questions</a></li>
              <li><a href="mentor_questions.php"><i class="fa fa-circle-o"></i>Mentor Questions</a></li>
              <li><a href="maker_questions.php"><i class="fa fa-circle-o"></i>Maker Questions</a></li>
              <li><a href="monitor_questions.php"><i class="fa fa-circle-o"></i>Monitor Questions</a></li>
              <li><a href="monitor_comments.php"><i class="fa fa-circle-o"></i>Monitor Comments</a></li>
    ...
    <!-- Content Wrapper. Contains page content -->
      ...
      <!-- Content Header (Page header) -->
        ...
        <h1>
          Announcements
          <small>Start-up Talks</small>
        </h1>
        <ol class="breadcrumb">
          <li><a href="#"><i class="fa fa-dashboard"></i>Announcements</a></li>
          <li class="active">Start-up Talks</li>
        </ol>
      </section>
      <!-- Main content -->
         ...
         <div class="col-md-8">
           <div class="box box-info ">
              <div class="box-header with-border">
                <h3 class="box-title">Post new Start-up Talk</h3>
              </div>
              <div class="box-body">
                <div class="form-group">
                  <label for="talk_title">Talk title</label>
                  <input type="text" name="talk_title" id="talk_title" class="form-control" placeholder="Talk title..." required="">
                </div>
...
<script type="text/javascript">
 ...
 <script type="text/javascript">
    ...
    $(".post_workshop").click(function(){ 
        ...
        if(talk_title==""||eventdate==""||starttime==""||endtime==""||venue==""){
                  swal("Please fill all fields", "All fields are mandatory", "warning");
        }        
        else{
          var eventtime = starttime+' - '+endtime;
          var dataString ='talk_title='+talk_title+'&eventdate='+eventdate+'&eventtime='+eventtime+'&venue='+venue;

          $.ajax({
                type: "POST",
                url: "send/add_startup_talk.php",
                data: dataString,
                success: function(data) {
                  swal("Workshop posted", " ", "success");
                  location.reload();
                }
            });
        }
