        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview active">
            ...
            <ul class="treeview-menu">
              <li class="active"><a href="workshops.php"><i class="fa fa-wrench"></i>WorkShops</a></li>
         ...
         <div class="col-md-8">
           <div class="box box-info ">
              <div class="box-header with-border">
                <h3 class="box-title">Post new workshop</h3>
              </div>
              <div class="box-body">
                <div class="form-group">
                  <label for="question_title">Workshop title</label>
                  <input type="text" name="workshop_title" id="workshop_title" class="form-control" placeholder="Workshop title..." required="">
                </div>
...
<script type="text/javascript">
 ...
 <script type="text/javascript">
    ...
    $(".post_workshop").click(function(){ 
        ...
        if(workshop_title==""||eventdate==""||starttime==""||endtime==""||venue==""){
                  swal("Please fill all fields", "All fields are mandatory", "warning");
        }        
        else{
          var eventtime = starttime+' - '+endtime;
          var dataString ='workshop_title='+workshop_title+'&eventdate='+eventdate+'&eventtime='+eventtime+'&venue='+venue;

          $.ajax({
                type: "POST",
                url: "send/add_workshop.php",
                data: dataString,
