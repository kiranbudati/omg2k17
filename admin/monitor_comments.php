  ...
  <div class="wrapper">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview active">
            ...
            <ul class="treeview-menu">
              ...
              <li class="active"><a href="monitor_comments.php"><i class="fa fa-question"></i>Monitor Comments</a></li>
    ...
    <!-- Content Wrapper. Contains page content -->
      ...
      <!-- Content Header (Page header) -->
        ...
        <h1>
          Comments
          <small>Monitor Comments</small>
        </h1>
        <ol class="breadcrumb">
          <li><a href="#"><i class="fa fa-dashboard"></i>Comments</a></li>
          <li class="active">Monitor Comments</li>
        </ol>
      </section>
      <!-- Main content -->
         ...
         <div class="box box-primary">
              ...
              <div class="box-body">
                <ul class="todo-list">
                  ...
                  $select_comments = "SELECT * FROM omg2k17_comments ORDER BY post_time ASC";

                  $fetch_comments = $con->prepare($select_comments);
                  $fetch_comments->bindParam(1,$question_to);

                  $fetch_comments->execute();
                  $row = $fetch_comments->fetchAll();
                  $num = $fetch_comments->rowCount();
                  if($num>0){
                    ...
                    $post_time=get_timeago(strtotime($ft_qu['post_time']));
                      ...
                      echo '<li>
                            ...
                            <span class="text" style="word-break: break-all">'.$ft_qu['comment'].'
                            </span>
                            <small><a>'.$post_time.'</a> by <a>'.$ft_qu['com_auth_email'].'</a></small>
                            <div class="tools">
      ...
      $(".delete").click(function(){ 
        var delete_id= this.id;  
         var deleteString = 'delete_id='+delete_id;
          $.ajax({
                type: "POST",
                url: "delete/delete_comments.php",
                data: deleteString,
                success: function(data) {
                  if(data=='deleted'){
                    swal("Comment Deleted", "", "success");
