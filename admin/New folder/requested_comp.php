...
<?php 
    ...
    $requ = "SELECT * FROM requests WHERE status = 'Waiting' ";
...
<section>
    <div class="container panel  panel-body">
        <div class="row ">
            ...
            <div class="col-sm-2">
                <a href="requested_comp.php" class="btn btn-success  btn-block">Requests<span class="badge">&nbsp;<?php echo $num_rows ?></span></a> 
            </div>
            <div class="col-sm-1">
               ...
               while($req=mysql_fetch_array($requests)){
                        ?>  
                          <tr  name="<?php echo $req['id']; ?>" class="active">
                            ...
                            <td>
                                <a href='allot.php?id=<?php echo $req['id'] ?>' name="allot" class="btn btn-success">Allot</a>
                                <a href="delete.php?id=<?php echo $req['id'] ?>" name="delete" class="btn btn-danger">Decline</a>
                            </td>
                          </tr>
                         <?php    
                          } 
